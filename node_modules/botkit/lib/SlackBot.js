...
function Slackbot(configuration) {
  ...
  slack_botkit.configureSlackApp = function(slack_app_config,cb) {
    ...
    console.log("slackbot clientid: " + slack_app_config.clientId);
    if (!slack_app_config || !slack_app_config.clientId || !slack_app_config.clientSecret || !slack_app_config.scopes) {
      ...
      console.log("CHECKIN");
      console.log("slackbot clientid2: " + slack_app_config.clientId);
    ...
    console.log("slackbot clientid3: " + slack_app_config.clientId);
    console.log("slack_botkit.config.clientid: " + slack_botkit.config.clientId);
    console.log(slack_botkit);
    console.log("the stuff above is slack_botkit");
    return slack_botkit;
  ...
  slack_botkit.createOauthEndpoints = function(webserver,callback) {
    console.log("slack_botkit.config.clientId 2: " + slack_botkit.config.clientId);

    slack_botkit.log('** Serving login URL: http://dunshire-slack.herokuapp.com:' + slack_botkit.config.port + '/login');
